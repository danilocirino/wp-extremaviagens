        ...
        foreach( $theme_array as $theme_list ){
            ...
            <div class="wptravelengine">
                <div class="theme-image">
                    <a class="theme-link" href="<?php echo esc_url( 'https://wptravelengine.com' . $theme_link .'?utm_source=travel_monster&utm_medium=pro_addon&utm_campaign=upgrade_to_pro'); ?>" target="_blank" rel="nofollow">
                        <img data-layzr="<?php echo esc_url( $theme_image ); ?>" src="<?php echo esc_url( $theme_image ); ?>" alt="">
                    </a>
                </div>
                <h3><a href="<?php echo esc_url( 'https://wptravelengine.com' . $theme_link .'?utm_source=travel_monster&utm_medium=pro_addon&utm_campaign=upgrade_to_pro'); ?>"><?php echo esc_html( $theme_title ); ?></a></h3>
